...
double task16()
{
    ...
    cout << "Enter the number: " << endl;
    cin >> num;
    if (num/100000 + num/10000%10 + num/1000%100 == num/100%1000 + num/10%10000 + num%100000)
    {
...
{
    int num;
    std::cout << "Enter the number of task (from 1 to 21):" << std::endl; ////Выбор номера задания
